...
def upgrade():
    ...
    op.bulk_insert(hosts,
        [
            {'id':1, 'name':'merger1', 'host_url':'na62merger1.cern.ch'},
            {'id':2, 'name':'merger2', 'host_url':'na62merger2.cern.ch'},
            {'id':3, 'name':'merger3', 'host_url':'na62merger3.cern.ch'},
            {'id':4, 'name':'merger4', 'host_url':'na62merger4.cern.ch'},
            {'id':5, 'name':'merger5', 'host_url':'na62merger5.cern.ch'},
            {'id':6, 'name':'na62primitive', 'host_url':'na62primitive.cern.ch'},
            {'id':7, 'name':'CASTOR', 'host_url':'srm-public.cern.ch:8443/srm/managerv2?SFN='},
            {'id':8, 'name':'EOS', 'host_url':'root://eospublic.cern.ch/'},
            {'id':9, 'name':'localsrc', 'host_url':'cc7alembicsqlalchemy.cern.ch'}
        ]
    )
